...
const getAnimals = (formData = {}) => {
  // This function is actually capable of making two types of requests; 
  // it will depend on how the queryUrl ends up looking. 
  ...
  fetch(queryUrl)
    .then(response => {
      ...
      // use the .json() method to parse our response into readable JSON format.
